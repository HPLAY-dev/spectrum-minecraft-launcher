...
impl OAuthClient {
    ...
    async fn authenticate_minecraft(
        ...
        let resp = client
            ...
            .send()
            .await
            .map_err(|e| CoreError::OAuth(format!("Minecraft 认证失败: {}", e)))?;
        ...
        let auth_resp: MinecraftAuthResponse = resp.json().await
            .map_err(|e| CoreError::OAuth(format!("Minecraft 认证响应解析失败: {}", e)))?;
