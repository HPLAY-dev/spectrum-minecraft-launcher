...
def retranslateUi(self, MainWindow):
    ...
    self.label_31.setText(QCoreApplication.translate("MainWindow", string("ui", "versionList"), None))
    ...
    self.label_30.setText(QCoreApplication.translate("MainWindow", string("ui", "versionName"), None))
    self.checkBox_7.setText(QCoreApplication.translate("MainWindow", string("ui", "bmclapiMirror"), None))
    ...
    self.pushButton_28.setText(QCoreApplication.translate("MainWindow", string("ui", "download"), None))
    ...
    self.mainTabWidget.setTabText(self.mainTabWidget.indexOf(self.tab_4), QCoreApplication.translate('MainWindow', string("ui", "downloadTab")+' LabyMod'))
    ...
    self.mainTabWidget.setTabText(self.mainTabWidget.indexOf(self.tab), QCoreApplication.translate("MainWindow", string("ui", "accountTab"), None))
    self.label_2.setText(QCoreApplication.translate("MainWindow", string("ui", "importedJavas"), None))
    self.label_3.setText(QCoreApplication.translate("MainWindow", string("ui", "loginAs"), None))
    self.pushButton_2.setText(QCoreApplication.translate("MainWindow", string("ui", "saveAccounts"), None))
    self.label_4.setText(QCoreApplication.translate("MainWindow", string("ui", "accountType"), None))
    self.comboBox_9.setItemText(0, QCoreApplication.translate("MainWindow", string("ui", "offline"), None))
    self.comboBox_9.setItemText(1, QCoreApplication.translate("MainWindow", string("ui", "microsoft"), None))
    self.pushButton_24.setText(QCoreApplication.translate("MainWindow", string("ui", "continueViaBrowser"), None))
    self.label_18.setText(QCoreApplication.translate("MainWindow", string("ui", "accountName"), None))
